      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            isClickedHome
                ?  Expanded(child: CategoryGridViewWithName(itemModel: homeItem,))
                : isClickedTools
                    ? const NotFoundView()
                    : isClickedProgram
                        ?  Expanded(child: CategoryGridViewWithoutName(itemModel: programsItem,))
                        : isClickedSection
                            ?  Expanded(
                                child: CategoryGridViewWithName(itemModel: sectionsItem,))
                            : isClickedLectures
                                ?  Expanded(
                                    child: CategoryGridViewWithName(itemModel: lecturesItem,))
                                : const Text("")
          ],
        ),
      ),
